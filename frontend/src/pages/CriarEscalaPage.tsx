...
const CriarEscalaPage = () => {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Nova Escala</h1>
        <p className="text-gray-600">Preencha os dados da nova escala</p>
      </div>
...
export default CriarEscalaPage;